  ...
  <div>
    <div>
      ...
      <el-form :model="webInfo"
        ...
        <el-form-item label="备案号"
                      prop="icpNumber">
          <el-input v-model="webInfo.icpNumber"></el-input>
        </el-form-item>
        ...
        <el-form-item label="状态"
                      prop="status">
          <el-switch @click.native="changeWebStatus(webInfo)"
                     v-model="webInfo.status"></el-switch>
        </el-form-item>
        ...
        <el-form-item label="提示"
          ...
          <div style="display: flex">
            <el-input :disabled="disabled"
                      :rows="6"
                      type="textarea"
                      v-model="webInfo.waifuJson"></el-input>
            <i class="el-icon-edit my-icon"
    ...
    <div>
      ...
      <el-button v-else
                 ...
                 size="small"
                 @click="showNoticeInput()">+ 公告</el-button>
      <div class="myCenter"
           style="margin-bottom: 22px">
        <el-button type="primary"
                   @click="saveNotice()">保存</el-button>
      </div>
    </div>
    ...
    <div>
      ...
      <el-button v-else
                 class="button-new-tag"
                 size="small"
                 @click="showRandomNameInput">+ 随机名称</el-button>
      <div class="myCenter"
           style="margin-bottom: 22px">
        <el-button type="primary"
                   @click="saveRandomName()">保存</el-button>
      </div>
    </div>
    ...
    <div>
      ...
      <div :key="i"
        ...
        <el-tag style="white-space: normal;height: unset"
                closable
                :disable-transitions="false"
      ...
      <el-button v-else
                 class="button-new-tag"
                 size="small"
                 @click="showRandomAvatarInput">+ 随机头像</el-button>
      <uploadPicture :isAdmin="true"
                     :prefix="'randomAvatar'"
                     style="margin: 10px"
      ...
      <div class="myCenter"
           style="margin-bottom: 22px">
        <el-button type="primary"
                   @click="saveRandomAvatar()">保存</el-button>
      </div>
    </div>
    ...
    <div>
      ...
      <el-button v-else
                 class="button-new-tag"
                 size="small"
                 @click="showRandomCoverInput">+ 随机封面</el-button>
      <uploadPicture :isAdmin="true"
                     :prefix="'randomCover'"
                     style="margin: 10px"
      ...
      <div class="myCenter"
        ...
        <el-button type="primary"
                   @click="saveRandomCover()">保存</el-button>
      </div>
    </div>

    <div>
      <el-button type="danger"
                 @click="resetForm('ruleForm')">重置所有修改</el-button>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    changeWebStatus(webInfo) {
      this.$http
        .post(
          this.$constant.baseURL + '/webInfo/updateWebInfo',
          {
            id: webInfo.id,
      ...
      this.$http
        ...
        .then((res) => {
          if (!this.$common.isEmpty(res.data)) {
            ...
            this.webInfo.icpNumber = res.data.icpNumber
