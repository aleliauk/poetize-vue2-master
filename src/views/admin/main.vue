<template>
  <div>
    <div class="header shadow-box-box border-radius">
      <div class="avatar">
        <el-avatar class="user-avatar" :size="100"
    ...
    <div class="information myBetween">
      <div v-for="item in $store.state.information" :key="item.id" :title="item.title"
        :style="{ backgroundColor: item.bgc }" class="information-item userTotal shadow-box-box">
