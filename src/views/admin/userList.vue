  ...
  <div>
    <div>
      <div class="handle-box">
        <el-select v-model="pagination.userType"
                   placeholder="用户类型"
        ...
        <el-select v-model="pagination.userStatus"
                   placeholder="用户状态"
                   class="handle-select mrb10">
          <el-option key="1"
                     label="启用"
        ...
        <el-input v-model="pagination.searchKey"
                  placeholder="用户名/手机号"
        ...
        <el-button type="danger"
                   @click="clearSearch()">清除参数</el-button>
      </div>
      <el-table :data="users"
                border
                class="table"
        ...
        <el-table-column label="用户状态"
          ...
          <template slot-scope="scope">
            ...
            <el-switch @click.native="changeUserStatus(scope.row)"
